...
### CRITICAL
- Never call ContentResolver.delete() on content://sms except as a direct result of an explicit user delete action. Never delete during sync, migration, or any background operation.