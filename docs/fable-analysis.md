...
### 🔵 Housekeeping
- [ ] 31. Standardize Toast vs. Snackbar usage (currently 4/4 split for near-identical actions); ~~add haptic feedback (currently zero anywhere in `ui/`)~~ — haptics landed July 16, 2026 (reaction toggle, long-press action-mode entry, row long-press, pin/unpin; performance-analysis Tier 3 #21). Toast/Snackbar standardization still open.
